...
Built with a modern React frontend and a Node.js + Express backend, this project demonstrates secure file handling, cloud storage integration, and clean UI design.
